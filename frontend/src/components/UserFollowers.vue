                    ...
                    <div class="col">
                        <nav aria-label="breadcrumb" class="rounded-3 p-3 mb-4">
                            <ol class="breadcrumb mb-0">
                                ...
                                <li class="breadcrumb-item">
                                    <a data-th-href="@{/home/profile/{username} (username=${username})}">Profile</a>
                                </li>
                    ...
                    <div class="col col-lg-9 col-xl-11">
                        <div class="card">
                            <div class="p-3 bg-white text-center">
                                <h1>[[ ${tab} ]]</h1>
                                <div class="d-flex flex-row justify-content-between align-items-center card-user"
                                    data-th-each="f : ${follow}">
                                    <div class="d-flex flex-row align-items-center">
                                        <a data-th-href="@{/home/profile/{username} (username=${f.username})}"
                                            class="fill-div">
                                            <p data-th-if="${f.avatar == null}">
                                                <img src="data:image/png;base64,"
                                                    alt="Generic placeholder image" class="rounded-circle shadow" width="55"
                                                    height="55" />
                                            </p>
                                            <p data-th-if="${f.avatar != null}">
                                                <img data-th-src="@{ ${f.getUserAvatar} }" alt="Generic placeholder image"
                                                    class="rounded-circle shadow" width="55" height="55" />
                                            </p>
                                            <div class="d-flex flex-column align-items-start ml-2">
                                                <span class="font-weight-bold">
                                                    [[ ${f.firstname} + ' ' + ${f.lastname} ]] </span><span
                                                    class="followers"> [[ ${f.username} ]] </span>
                                            </div>
                                        </a>
                                    </div>
                                    <div class="d-flex flex-row align-items-center mt-2">
                                        <div
                                            data-th-if="${#lists.contains(userFollowingList, f) == false and currentUser.username != f.username}">
                                            <form
                                                data-th-action="@{/home/profile/{currentUsername}/follow/{username}/{tab} (currentUsername=${user.username}, username=${f.username}, tab=${tab})}"
                                                method="POST">
                                        ...
                                        <div
                                            data-th-if="${#lists.contains(userFollowingList, f) and currentUser.username != f.username}">
                                            <form
                                                data-th-action="@{/home/profile/{currentUsername}/unfollow/{username}/{tab} (currentUsername=${user.username}, username=${f.username}, tab=${tab})}"
                                                method="POST">
                                                <button class="btn btn-outline-primary btn-sm" type="submit">
                                                    Unfollow
                                                </button>
